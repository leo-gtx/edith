...
//Application Title
define('APP_TITLE', 'Edith File Manager');
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        <div class="card fat <?php echo fm_get_theme(); ?>">
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="mb-3">
                                       <div class="brand">
                                            <svg version="1.0" xmlns="http://www.w3.org/2000/svg" M1008 width="100%" height="80px" viewBox="0 0 238.000000 140.000000" aria-label="EFM Edith File Manager">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="#" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">Edith Axel</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-12">
                        <p><h3><a href="#" target="_blank" class="app-v-title"> Edith File Manager <?php echo VERSION; ?></a></h3></p>
                        <p>Author: Axel Edith</p>
                        <!-- <p>Mail Us: <a href="mailto:mail">gmail.com</a> </p> -->
                    </div>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="#" target="_blank" class="float-right text-muted">Edith File Manager <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="#" target="_blank" class="float-right text-muted">Edith File Manager <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'Edith File Manager<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
<head>
    ...
    <meta name="description" content="Web based File Manager in PHP, Manage your files efficiently and easily with Edith File Manager">
    <meta name="author" content="Edith Axel">
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Edith File Manager';      $tr['en']['AppTitle']           = 'File Manager';
